...
<!DOCTYPE html>
<html lang="en">
    <?php if ($template_head == TRUE) $this->load->view('templates_/head'); ?>
    <?php if ($template_header == TRUE) $this->load->view('templates_/header'); ?>
    <?php
    if ($template_body == TRUE) {
        $this->load->view('templates_/body');
    } else {
        $this->load->view($v);
    };
    ?>
<?php if ($template_footer == TRUE) $this->load->view('templates_/footer'); ?>
</div><!-- ./wrapper -->
</body>
