...
<style>
    ...
    $menu = array(
        ...
        'Form' => array('icon' => 'fa fa-plus-circle', 'link' => base_url(), 'c' => '', 'group' => array('2'), 'submenu' => array(
                ...
                'Form Telkom' => array('link' => site_url('/logbook/create?telkom=true')),
                'Workbook Telkomsel' => array('link' => site_url('/logbook/create')),
                'Restitusi/Claim/Ticketing' => array('link' => site_url('/rast/new')),
                'Reaktivasi Kartu Halo' => array('link' => site_url('/ReaktivasiKartuHalo/create')),
                'Ceklist GK Mbanking' => array('link' => site_url('/Mbanking_Controller/mbanking')),
                //'SP Mbanking' => array('link' => site_url('/Mbanking_Controller/sp'))
                'Restitusi & Lap Plgn' => array('link' => site_url('/Restitusi_controller/restitusi'))
            )),
        'View' => array('icon' => 'fa fa-book', 'link' => '#', 'c' => '', 'group' => array('2'), 'submenu' => array(
                ...
                'Restitusi/Claim/Ticketing' => array('link' => site_url('rast_controler')),
                'Reaktivasi Kartu Halo' => array('link' => site_url('/ReaktivasiKartuHalo')),
                'List GK Mbanking' => array('link' => site_url('/Mbanking_Controller/mbanking_list')),
                // 'Revenue Prepaid & Postpaid' =>  array('link' => site_url('laporan')),
                //'Croselling Telkom (underwere)' => array('link' => site_url('/logbook/croselling')),
                //'List SP Mbanking' => array('link' => site_url('/Mbanking_Controller/sp_list')),
                'List Rest & Lap' => array('link' => site_url('/Restitusi_controller/restitusi_list')),
                'Starla List' => array('link' => site_url('/Starla_controller/plcsr_list')),
            )),
        ...
        'Rekap Aimer' => array('icon' => 'fa fa-calendar', 'c' => 'user', 'link' => site_url('/laporan/resttimer')),
        'STARLA' => array('icon' => 'fa fa-book', 'c' => 'user', 'link' => site_url('/Starla_controller/plcsr'),'group' => array('1')),
        'Laporan Starla' => array('icon' => 'fa fa-book', 'c' => 'user', 'link' => site_url('/Starla_controller/report_starla')),
        'Data Grapari' => array('icon' => 'fa fa-book', 'c' => 'user', 'link' => site_url('/Excel_import')),
        'E-form & E-sign' => array('icon' => 'fa fa-book', 'c' => 'user', 'link' => site_url('/Esign_controller/esign')),
...
<style>
    ...
    aside.main-sidebar.animated.fadeInLeftBig {
        width: 235px;
    }
</style>
        ...
        <header class="main-header animated fadeInDownBig" style="">
            ...
            <nav class="navbar navbar-static-top">
                ...
                <div class="col-md-12">
                    ...
                    <div class="marquee">
                        SEBELUM DAN SESUDAH ISTIRAHAT WAJIB MELAKUKAN LOGIN DAN LOGOUT ISTIRAHAT.
                        UNTUK HASIL CROSS AND UP SELLING DI ENTRY SECARA REAL TIME.
                        KEPADA SELURUH CA AGAR SELALU KONSISTEN MELAKUKAN ENTRY DATA PADA WORKBOOK SIANIDA UNTUK SETIAP PELANGGAN YANG DILAYANI DENGAN MEMILIH KATEGORI YANG SESUAI.
                        MENGENTRI DATA PALSU AKAN DIBERIKAN SP 1. TERIMAKASIH :) DAN TETAP SEMANGAT...!!!
                    </div>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel" style="height: 100px;">
                    <div class="pull-left">
                        ...
                        <img src="<?php echo base_url('/gambar/'.$this->ion_auth->user()->row()->username) ?>.jpg" onerror="this.src='<?php echo base_url('/gambar/user.png') ?>'" class="img-circle" alt="User Image" style="width:80px;height:80px">
                      
                    </div>
                    <div class="pull-left info" style="margin-left:25px;">

                        <p style="color:#000;"><?php echo sprintf('<small>%s</small>', $this->ion_auth->user()->row()->full_name) ?> </p>
          ...
          ', $attr_current, $treeview_class, $value['link'], $menu_icon, $filename, $menu_sub_class);
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <img style="width:200px; heigth:100px;" src="<?= base_url('/gambar/tenor.gif') ?>" alt="">
                </div>
